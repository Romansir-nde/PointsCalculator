...
export const KUCCPS_2024_CUTOFFS: Record<number, ClusterCutoffData> = {
  ...
  2: {
    clusterId: 2,
    clusterName: 'Business, Hospitality & Related',
    universities: [
  ...
  3: {
    clusterId: 3,
    clusterName: 'Social Sciences, Media Studies, Fine Arts, Film, Animation, Graphics & Related',
    universities: [
  ...
  4: {
    clusterId: 4,
    clusterName: 'Geosciences & Related',
    universities: [
  ...
  5: {
    clusterId: 5,
    clusterName: 'Engineering, Engineering Technology & Related',
    universities: [
    ...
    averageCutoff: 42.4,
    minRequiredForEntry: 35.0,
  },
  6: {
    clusterId: 6,
    clusterName: 'Architecture, Building Construction & Related',
    universities: [
  ...
  9: {
    clusterId: 9,
    clusterName: 'General Science, Biological Sciences, Physics, Chemistry & Related',
    universities: [
  ...
  10: {
    clusterId: 10,
    clusterName: 'Actuarial Science, Accountancy, Mathematics, Economics, Statistics & Related',
    universities: [
  ...
  11: {
    clusterId: 11,
    clusterName: 'Interior Design, Fashion Design, Textiles & Related',
    universities: [
  ...
  12: {
    clusterId: 12,
    clusterName: 'Sport Science & Related',
    universities: [
  ...
  13: {
    clusterId: 13,
    clusterName: 'Medicine, Health, Veterinary Medicine & Related',
    universities: [
    ...
    averageCutoff: 45.5,
    minRequiredForEntry: 38.0,
  },
  14: {
    clusterId: 14,
    clusterName: 'History, Archeology & Related',
    universities: [
  ...
  15: {
    clusterId: 15,
    clusterName: 'Agriculture, Animal Health, Food Science, Nutrition Dietetics, Environmental Sciences, Natural Resources & Related',
    universities: [
  ...
  20: {
    clusterId: 20,
    clusterName: 'Religious Studies, Theology, Islamic Studies & Related',
    universities: [
  ...
  3: {
    clusterId: 3,
    clusterName: 'Biological Sciences',
    universities: [
      { university: 'University of Nairobi', cutoffPoints: 43.8, programmeCount: 5 },
      { university: 'Moi University', cutoffPoints: 41.2, programmeCount: 3 },
      { university: 'Kenyatta University', cutoffPoints: 38.0, programmeCount: 2 },
  ...
  4: {
    clusterId: 4,
    clusterName: 'Technical/Applied Sciences',
    universities: [
      { university: 'JKUAT', cutoffPoints: 42.0, programmeCount: 3 },
      { university: 'Technical University of Kenya', cutoffPoints: 38.5, programmeCount: 4 },
      { university: 'Moi University', cutoffPoints: 37.0, programmeCount: 2 },
    ],
    averageCutoff: 39.2,
    minRequiredForEntry: 32.0,
  },
  ...
  6: {
    clusterId: 6,
    clusterName: 'Arts/Social Sciences',
    universities: [
      { university: 'University of Nairobi', cutoffPoints: 40.5, programmeCount: 5 },
      { university: 'Moi University', cutoffPoints: 37.2, programmeCount: 3 },
      { university: 'Kenyatta University', cutoffPoints: 36.8, programmeCount: 3 },
  ...
  8: {
    clusterId: 8,
    clusterName: 'Medicine/Health Sciences',
    universities: [
      { university: 'University of Nairobi', cutoffPoints: 48.5, programmeCount: 4 },
      { university: 'JKUAT', cutoffPoints: 46.2, programmeCount: 2 },
      { university: 'Moi University', cutoffPoints: 44.8, programmeCount: 3 },
  ...
  10: {
    clusterId: 10,
    clusterName: 'Architecture/Building',
    universities: [
      { university: 'JKUAT', cutoffPoints: 43.5, programmeCount: 3 },
      { university: 'University of Nairobi', cutoffPoints: 42.8, programmeCount: 2 },
      { university: 'Kenyatta University', cutoffPoints: 39.2, programmeCount: 1 },
  ...
  14: {
    clusterId: 14,
    clusterName: 'Languages/Literature',
    universities: [
  ...
  15: {
    clusterId: 15,
    clusterName: 'Mass Communication',
    universities: [
      { university: 'University of Nairobi', cutoffPoints: 41.2, programmeCount: 2 },
      { university: 'JKUAT', cutoffPoints: 39.5, programmeCount: 1 },
      { university: 'Moi University', cutoffPoints: 38.0, programmeCount: 1 },
    ],
    averageCutoff: 39.6,
    minRequiredForEntry: 33.0,
  },
  ...
  18: {
    clusterId: 18,
    clusterName: 'Geography/Environmental Studies',
    universities: [
      { university: 'University of Nairobi', cutoffPoints: 41.2, programmeCount: 2 },
      { university: 'Moi University', cutoffPoints: 39.8, programmeCount: 2 },
      { university: 'Egerton University', cutoffPoints: 38.5, programmeCount: 1 },
  ...
  19: {
    clusterId: 19,
    clusterName: 'Home Science/Hospitality',
    universities: [
      { university: 'Kenyatta University', cutoffPoints: 38.5, programmeCount: 2 },
      { university: 'Egerton University', cutoffPoints: 37.0, programmeCount: 1 },
      { university: 'Moi University', cutoffPoints: 36.2, programmeCount: 1 },
    ],
    averageCutoff: 37.2,
    minRequiredForEntry: 31.0,
  },
